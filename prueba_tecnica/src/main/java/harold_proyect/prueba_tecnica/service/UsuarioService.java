...
import harold_proyect.prueba_tecnica.repository.UsuarioRepository;
...
public class UsuarioService implements UsuarioRepository{
    ...
    @Override
    public <S extends Usuario> List<S> saveAllAndFlush(Iterable<S> itrbl) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void deleteAllInBatch(Iterable<Usuario> itrbl) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
